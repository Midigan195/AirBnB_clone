...
"""
Define a test class for Place
"""


class TestPlace(unittest.TestCase):
    """
    Define a list of test suites for Place
    """
    ...
    def test_nomrmal_str(self):
        """
        Test __str__ method with a normal case of Place
        """
        obj = Place()
    ...
    def test_to_dict_with_added_attrs(self):
        ...
        self.assertIn("surname", place.to_dict())
        self.assertEqual("Jeffry", place.to_dict()["name"])
        self.assertEqual("Bezos", place.to_dict()["surname"])
